...
const CATEGORIES = [
  ...
  { value: "Academics/Scientists/Technologist – ₦40,000",       label: "Academics / Scientists / Technologist — ₦40,000" },
...
function validate(fields) {
  ...
  if (!fields.affiliation.trim()) errors.affiliation = "Affiliation is required.";
...
export default function Registration() {
  ...
  return (
    <section id="register" className="py-24" style={{ background: "#f3f8fe" }}>
      <div
        ref={ref}
      ...
      >
        ...
        <div className="text-center mb-10">
          <div
            ...
            style={{ background: "rgba(30,74,122,0.08)", color: palette.blueMid }}
          >
            Secure Your Spot
          </div>
          <h2
        ...
        >
          <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-5">
            ...
            <InputField
              label="Full Name" id="fullname" placeholder="e.g. Dr. Jane Okonkwo"
              value={fields.fullname} onChange={set("fullname")} error={errors.fullname}
            />
            <InputField
              label="Affiliation" id="affiliation" placeholder="University / Institute / Company"
              value={fields.affiliation} onChange={set("affiliation")} error={errors.affiliation}
            />
            <InputField
              label="Email Address" id="email" type="email" placeholder="jane@science.edu"
            ...
            <div>
              ...
              >
                Payment Category <span style={{ color: "#c0392b" }}>*</span>
              </label>
              <select
                id="amount"
                value={fields.amount}
                ...
                style={{
                  padding:    "13px 16px",
                  border:     errors.amount ? "1.5px solid #e74c3c" : "1.5px solid #dbe3f0",
                  outline:    "none",
                  background: "#fff",
                  color:      fields.amount ? "#0b1e3a" : "#94a3b8",
                }}
                onFocus={(e) => {
                  e.target.style.border    = `1.5px solid ${palette.blueMid}`;
                  e.target.style.boxShadow = "0 0 0 4px rgba(30,74,122,0.12)";
                }}
                onBlur={(e) => {
                  e.target.style.border    = errors.amount ? "1.5px solid #e74c3c" : "1.5px solid #dbe3f0";
                  e.target.style.boxShadow = "none";
                }}
              >
                <option value="" disabled>— Select registration category —</option>
                {CATEGORIES.map((c) => (
                  <option key={c.value} value={c.value} style={{ color: "#0b1e3a" }}>
                    {c.label}
                  </option>
                ))}
              </select>
            ...
            <button
              ...
              onMouseLeave={(e) => {
                e.currentTarget.style.background = submitting ? palette.blueMid : palette.blue;
            ...
            {status === "success" && (
              ...
              >
                ...
                <span>
                  Registration submitted successfully! A confirmation will be sent to your email shortly.
                </span>
              </div>
            )}
